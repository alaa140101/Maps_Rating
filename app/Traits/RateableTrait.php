...
trait RateableTrait
{
  ...
  {
    $avg = $place->reviews()
    ->selectRaw('avg(service_rating) service_rating, avg(quality_rating) quality_rating, avg(cleanliness_rating) cleainess_rating, avg(pricing_rating) pricing_rating')
    ->first();
