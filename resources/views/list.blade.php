<x-app-layout>
  ...
  <div class="py-12">
    @if (!$places->count())
      <div class="text-blue-900 px-6 py-4 rounded relative bg-gray-200 max-w-7xl mx-auto"><span class="inline-block align-middle mr-8">لايوجد مواقع صمن هذا التصنيف</span></div>
    @else     
